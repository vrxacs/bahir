...
object TwitterUtils {
  ...
  def createStream(
      ...
      filters: Map[String, Seq[String]] = Map[String, Seq[String]](),
  ...
  /**
    ...
    * @param storageLevel Storage level to use for storing the received objects
    */
  def createStreamArrayFilters(
                    ssc: StreamingContext,
                    twitterAuth: Option[Authorization],
                    filters: Array[String] = Array[String](),
                    storageLevel: StorageLevel = StorageLevel.MEMORY_AND_DISK_SER_2
                  ): ReceiverInputDStream[Status] = {
    val filtersMap: Map[String, Seq[String]] = Map("track" -> filters)
    new TwitterInputDStream(ssc, twitterAuth, filtersMap, storageLevel)
  }
   ...
   * @param filters Set of filter strings to get only those tweets that match them
   */
  def createStream(jssc: JavaStreamingContext, filters: Map[String, Seq[String]]
  ...
  def createStream(jssc: JavaStreamingContext, filters: Array[String]
    ...
    val filtersMap: Map[String, Seq[String]] = Map("track" -> filters)
    createStream(jssc.ssc, None, filtersMap)
  }
  ...
  def createStream(
    ...
    val filtersMap: Map[String, Seq[String]] = Map("track" -> filters)
    createStream(jssc.ssc, None, filtersMap, storageLevel)
  }
  ...
  def createStream(
    ...
    val filtersMap: Map[String, Seq[String]] = Map("track" -> filters)
    createStream(jssc.ssc, Some(twitterAuth), filtersMap)
  }
  ...
  def createStream(
    ...
    val filtersMap: Map[String, Seq[String]] = Map("track" -> filters)
    createStream(jssc.ssc, Some(twitterAuth), filtersMap, storageLevel)
  }
}
